...
<body>
    ...
    <div id="sessionModal" class="session-modal">
        <div class="modal-content">
            <div class="modal-header" id="sessionModalTitle">Power Usage Details</div>
    ...
    <script>
        ...
        function viewSession(session) {
            document.getElementById('sessionModalTitle').textContent = `Power Usage #${session.id} Details`;
