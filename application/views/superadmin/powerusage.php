...
<head>
    ...
    <style>
        ...
        .power-usage-modal.active ~ .wrapper #sidebar,
        .power-usage-modal.active ~ .wrapper .content {
            filter: blur(5px);
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="dashboard-container">
                    <div class="dashboard-header">
                        <h2 class="dashboard-title">Power Usage History</h2>
                        <div>
    ...
    <!-- Power Usage Modal -->
    <div id="powerUsageModal" class="power-usage-modal">
        <div class="modal-content">
            <div class="modal-header" id="modalTitle">Power Usage Details</div>
    ...
    <script>
        ...
        function applyFilters() {
            if (validateFilterForm()) {
                ...
                Swal.fire({
                    ...
                    text: 'Power usage history has been filtered successfully.',
                    timer: 1500,
        ...
        function viewSession(id) {
            ...
            if (session) {
                document.getElementById('modalTitle').textContent = `Power Usage #${session.id} Details`;
                ...
                `;
                document.getElementById('powerUsageModal').classList.add('active');
            }
        }

        // Close Modal
        function closeModal() {
            document.getElementById('powerUsageModal').classList.remove('active');
        }

        // Close on outside click
        window.onclick = function(event) {
            const modal = document.getElementById('powerUsageModal');
